cask "antigravity-tools" do
  ...
  on_macos do
    url "https://github.com/lbjlaq/Antigravity-Manager/releases/download/v#{version}/Antigravity_Tools_(Maximizer)_#{version}_universal.dmg"

    app "Antigravity Tools (Maximizer).app"
    ...
    caveats <<~EOS
      If you encounter the "App is damaged" error, please run the following command:
        sudo xattr -rd com.apple.quarantine "/Applications/Antigravity Tools (Maximizer).app"
